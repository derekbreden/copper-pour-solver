...
var convertCircuitJsonToInputProblem = (circuitJson, options) => {
  ...
  for (const elm of circuitJson) {
    if (elm.type === "pcb_smtpad") {
      ...
      const isThroughHole = platedHole.layers.includes("top") && platedHole.layers.includes("bottom");
      ...
      const via = elm;
      const isThroughVia = via.layers.includes("top") && via.layers.includes("bottom");
